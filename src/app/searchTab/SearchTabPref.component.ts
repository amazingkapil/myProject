...
@Component({
    selector: 'app-searchPref',
    templateUrl: './SearchTabPref.component.html',

  })

  export class SearchTabPrefComponent {
    public client;   
    pref:"";
    ...
    searchClient(ngForm){
      ...
      this.http.get('http://localhost:8080/CMSProject/jaxrs/clients/InvestPref/'+this.pref).subscribe(data=>{this.client = data["client"];
